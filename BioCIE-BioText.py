...
def main(argv):
    ...
    output_file = open('XAI model\\Output(conf0.7)-concept.txt', 'w')
    ...
    output_file = open('XAI model\\Model(conf0.7)-concept.xml', 'w')
    ...
    model = xml.dom.minidom.parse('XAI model\\Model(conf0.7)-concept.xml')
    ...
    output_file = open('Test\\Result(conf0.7)-concept.txt', 'w')
